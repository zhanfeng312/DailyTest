...
**
** Created: Tue Mar 31 10:43:45 2015
...
public:
    ...
    void setupUi(QDialog *YaoJiang)
    {
        ...
        label->setGeometry(QRect(90, 15, 66, 17));
        bstart = new QPushButton(YaoJiang);
        bstart->setObjectName(QString::fromUtf8("bstart"));
        bstart->setGeometry(QRect(50, 490, 98, 27));
        bstop = new QPushButton(YaoJiang);
        bstop->setObjectName(QString::fromUtf8("bstop"));
        bstop->setGeometry(QRect(220, 490, 98, 27));
        personName = new QLabel(YaoJiang);
        personName->setObjectName(QString::fromUtf8("personName"));
        personName->setGeometry(QRect(160, 9, 91, 31));
        QPalette palette;
        ...
        personName->setAutoFillBackground(true);
        personName->setFrameShape(QFrame::Box);
    ...
    void retranslateUi(QDialog *YaoJiang)
    {
        ...
        label->setText(QApplication::translate("YaoJiang", "\345\247\223\345\220\215", 0, QApplication::UnicodeUTF8));
